...
league_stats <- function(sw_league_id, games) {
...
make_report <- function(league_name, comp_no, league_ids, games) {
  ...
  stats <- league_stats(sw_league_id, games)
  if (length(tabs) == 0) {
...
walk2(names, comps, ~make_report(.x, .y, league_ids, games))
```
